...
Choose [Manual setup via `gcloud` commands](#manual-setup) or [Terraform setup](#terraform-setup).
...
1. Submit the Cloud Build config:
    ...
    * Builds and push containers to Artifact Registry, where **[Container Analysis](https://cloud.google.com/artifact-analysis/docs/artifact-analysis)** provides integrated on-demand or automated scanning for base container images, Maven & Go packages in containers, and for non-containerized Maven packages.
